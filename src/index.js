...
function buttons(event) {
  ...
  const input = event.target.closest('div').querySelector('input').value.toLowerCase()
...
function releasePokemon() {
  axios
    .delete(`${baseUrl}pokemon/release/${displayContainer.pokemon}`, {
      headers: {
        username,
      },
    })
...
// creats an element for each type so I cannp
